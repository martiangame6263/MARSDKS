...
s.source           = { :git => 'https://github.com/martiangame6263/MARSDKS.git', :tag => "MARSDKADVERT-#{s.version}" } # 这里输入邮箱如果你在开元中国申请的 git 账号,那么把你在开元中国创建的项目的 https 网址输入到这里,
s.platform     = :ios
s.platform     = :ios, "9.0" #iOS 支持的最低级别,这里最低9.0
s.resource_bundles = {
     'MARSDKADVERT' => ['MARSDKADVERT/Assets/*']
 }
# s.vendored_libraries =  'MARSDKADVERT/Classes/*.a'
s.vendored_frameworks  = 'MARSDKADVERT/SDK/*.framework'
# s.source_files = 'MARSDKEPSDK/Classes/*.{h,m,swift}'
# s.public_header_files = 'MARSDKEPSDK/Classes/*.h'
s.frameworks = "Security","SystemConfiguration"
s.ios.library = "z","c++","icucore"
